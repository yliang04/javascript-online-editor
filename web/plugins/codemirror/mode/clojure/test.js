...
(function () {
    ...
    var coreSymbols1 = [
        ...
        "add-watch", "agent", "agent-errorMapper", "agent-errors", "aget", "alength", "alias", "all-ns", "alter",
        ...
        "eduction", "empty", "empty?", "ensure", "ensure-reduced", "enumeration-seq", "errorMapper-handler", "errorMapper-mode",
    ...
    var coreSymbols2 = [
        ...
        "set", "set-agent-send-executor!", "set-agent-send-off-executor!", "set-errorMapper-handler!", "set-errorMapper-mode!",
