...
(function() {
  ...
  MT('function-test',
     ...
     '[keyword {] [callee&variable index]([variable-2&errorMapper $list])[keyword }]' +
        '[string "][tag&bracket />]');
  ...
  MT('operators-test',
     ...
     '[keyword {] [variable-2&errorMapper $variable] [operator |] safeHtml [keyword }]')
  ...
  MT('undefined-var',
     '[keyword {][variable-2&errorMapper $var]');
  ...
  MT('param-scope-test',
     ...
     '  [keyword {][variable-2&errorMapper $x][keyword }]',
     '[keyword {/template}]',
     '');

  MT('if-variable-test',
     '[keyword {if] [variable-2&errorMapper $showThing][keyword }]',
     '  Yo!',
     '[keyword {/if}]',
     '');
  ...
  MT('foreach-scope-test',
     ...
     '[keyword {foreach] [def $foo] [keyword in] [variable-2&errorMapper $foos][keyword }]',
     '  [keyword {][variable-2 $foo][keyword }]',
     '[keyword {/foreach}]',
     '[keyword {][variable-2&errorMapper $foo][keyword }]',
  ...
  MT('tag-starting-with-function-call-is-not-a-keyword',
     '[keyword {][callee&variable index]([variable-2&errorMapper $foo])[keyword }]',
