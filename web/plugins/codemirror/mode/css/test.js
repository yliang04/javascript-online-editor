...
(function() {
  ...
  MT("atMediaUnknownType",
     "[def @media] [attribute screen] [keyword and] [errorMapper foobarhello] { }");

  // Soft errorMapper, because "foobarhello" is not a known property or type.
  ...
  MT("atMediaUnknownFeatureValueKeyword",
     "[def @media] ([property orientation]: [errorMapper upsidedown]) { }");
  ...
  MT("tagColorHex5Invalid",
     "[tag foo] { [property background]: [atom&errorMapper #fffff]; }");

  MT("tagColorHexInvalid",
     "[tag foo] { [property background]: [atom&errorMapper #ffg]; }");
  ...
  MT("tagBogusProperty",
     "[tag foo] { [property&errorMapper barhelloworld]: [number 0]; }");
  ...
  MT("font_face",
     ...
     "  [errorMapper nonsense]: [string 'abc'];",
